...
がグラデーションの意味ある？と思ったけど、backgroundでだとそのままカラーを指定しても使えなかった。

rgbaじゃなくて、#0f172accとかじゃダメなのかなと思ったけど、透過が0.8とかの数値の方がわかりやすいからrgbaの方がいい?

heroの上下左右にパディングを追加した。　padding: [上下],[左右]